...
Route::controller(PropertyTypeController::class)->group(function(){
   ...
   Route::controller(PropertyController::class)->group(function(){
    ...
    Route::get('/admin/schedule/request/', 'AdminScheduleRequest')->name('admin.schedule.request'); 
    Route::get('/admin/details/schedule/{id}', 'AdminDetailsSchedule')->name('admin.details.schedule'); 
...
Route::controller(RoleController::class)->group(function(){
 ...
 Route::controller(AdminController::class)->group(function(){
    ...
    ///
  Route::get('/mortgage', 'MortgageController@showForm')->name('mortgage.form');
  Route::post('/mortgage/calculate', 'MortgageController@calculate')->name('mortgage.calculate');
...
Route::post('/add-to-wishList/{property_id}', [WishlistController::class, 'AddToWishList']);  
 ...
 Route::get('/property/type/{id}', [IndexController::class, 'PropertyType'])->name('property.type');
  ...
  Route::post('/rent/property/search', [IndexController::class, 'RentPropertySeach'])->name('rent.property.search');
   ...
   Route::get('/orders/create/{property}', [OrderController::class, 'create'])->name('orders.create');
...
Route::post('/mortgage/calculate', [MortgageController::class, 'calculate'])->name('mortgage.calculate');
